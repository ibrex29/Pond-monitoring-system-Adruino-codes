...
if (Firebase.ready() && signupOK ) {
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "/iot/sensor/turbidity",ntu)){
//      Serial.println("PASSED");
  ...
  if (Firebase.ready() && signupOK ) {
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "/iot/sensor/humidity",h)){
//      Serial.println("PASSED");
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "/iot/sensor/temperature", t)){
//      Serial.println("PASSED");
